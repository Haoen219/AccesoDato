...
public class ORM 
{
    ...
    private static Profesores profesores= new Profesores();
    ...
    private int menu()
    {
        ...
        while ((option<0))
        {
            ...
            System.out.println("|4|-Mantener Profesores    |");
    ...
    private static int menuProfesores(){
        int opcion=0;
        //Alumnos gestorAlumnos=new Alumnos();
        do{
            try{
                opcion=profesores.menu();
                switch(opcion){
                    case 0 -> System.out.println("Volviendo al menu previo...\n");
                    case 1 -> profesores.darDeAlta();
                    case 2 -> profesores.darDeBaja();
                    case 3 -> profesores.modificar();
                    case 4 -> profesores.matricularModulo();
                    case 5 -> profesores.importar();
                    case 6 -> profesores.exportar();
                    default -> System.out.println("--Opción no valida");
                }
            }catch(InputMismatchException ex){
                System.out.println("\n###ERROR: ha introducido un valor que no es entero.");
